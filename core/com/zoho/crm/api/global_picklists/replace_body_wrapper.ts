import {ReplacePicklistValues} from "./replace_picklist_values";
import {Model} from "../../../../../../utils/util/model";

class ReplaceBodyWrapper implements Model{

	private replacePicklistValues: Array<ReplacePicklistValues>;
	private keyModified: Map<string, number> = new Map<string, number>();
	/**
	 * The method to get the replacePicklistValues
	 * @returns An Array representing the replacePicklistValues
	 */
	public getReplacePicklistValues(): Array<ReplacePicklistValues>	{
	 ...
	 */
	public setReplacePicklistValues(replacePicklistValues: Array<ReplacePicklistValues>): void	{
