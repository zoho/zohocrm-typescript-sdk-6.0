...
class TagsOperations{
	 ...
	 * @throws SDKException
	 */
	public async addTags(recordId: bigint, moduleAPIName: string, request: NewTagRequestWrapper, paramInstance?: ParameterMap): Promise<APIResponse<RecordActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
	 ...
	 * @throws SDKException
	 */
	public async removeTags(recordId: bigint, moduleAPIName: string, request: ExistingTagRequestWrapper): Promise<APIResponse<RecordActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/");
		apiPath = apiPath.concat(moduleAPIName.toString());
	 ...
	 * @throws SDKException
	 */
	public async addTagsToMultipleRecords(moduleAPIName: string, request: NewTagRequestWrapper, paramInstance?: ParameterMap): Promise<APIResponse<RecordActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/");
		apiPath = apiPath.concat(moduleAPIName.toString());
	 ...
	 * @throws SDKException
	 */
	public async removeTagsFromMultipleRecords(moduleAPIName: string, request: ExistingTagRequestWrapper, paramInstance?: ParameterMap): Promise<APIResponse<RecordActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/");
		apiPath = apiPath.concat(moduleAPIName.toString());
