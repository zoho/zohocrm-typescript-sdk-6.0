...
class Feature implements Model{
	 ...
	 * @returns An instance of Feature
	 */
	public getParentFeature(): Feature	{
	 ...
	 */
	public setParentFeature(parentFeature: Feature): void	{
	 ...
	 * @returns An Array representing the components
	 */
	 ...
	 * @param components An Array representing the components
	 */
	public setComponents(components: Array<Component>): void	{
