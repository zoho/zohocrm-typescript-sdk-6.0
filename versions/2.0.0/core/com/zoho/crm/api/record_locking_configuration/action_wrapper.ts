...
class ActionWrapper implements Model{
	...
	private recordLockingConfigurations: Array<ActionResponse>;
	 ...
	 */
	public getRecordLockingConfigurations(): Array<ActionResponse>	{
	 ...
	 */
	public setRecordLockingConfigurations(recordLockingConfigurations: Array<ActionResponse>): void	{
