...
class User extends MinifiedUser implements Model{

	protected zuid: number;
	 ...
	 * @returns A number representing the zuid
	 */
	public getZuid(): number	{
		return this.zuid;
	 ...
	 * @param zuid A number representing the zuid
	 */
	public setZuid(zuid: number): void	{
		this.zuid = zuid;
