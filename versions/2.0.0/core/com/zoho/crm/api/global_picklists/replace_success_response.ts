...
class ReplaceSuccessResponse implements Model, ReplaceActionResponse{
...
export {
	ReplaceSuccessResponse as MasterModel,
	ReplaceSuccessResponse as ReplaceSuccessResponse
}
