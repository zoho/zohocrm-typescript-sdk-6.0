...
import {InventoryTemplates} from "../inventory_templates/inventory_templates";
import {ModuleMap} from "../inventory_templates/module_map";
import {User} from "../inventory_templates/user";
...
class EmailTemplate extends InventoryTemplates implements Model, Template{
	...
	protected module: ModuleMap;
	protected createdBy: User;
	protected modifiedBy: User;
	 ...
	 * @returns A String representing the mailContent
	 */
	 ...
	 */
	public setMailContent(mailContent: string): void	{
