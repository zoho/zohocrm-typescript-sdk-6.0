export class Constants {
    ...
    public static USER_SIGNATURE = "user_signature";
    public static REVOKE_URL = "/revoke";
    public static STATUS_SUCCESS = "success";
    public static REVOKE_TOKEN_ERROR = "Exception while revoke the refresh token.";
    public static TOKEN_NOT_FOUND = " No tokens exist for the given user-id.";
    public static REFRESH_TOKEN_REMOVED = "Refresh token revoked successfully";
    public static GET_TOKEN_DB_ERROR1 = "Exception in DBStore : Given user authentication details not found.";
    public static GENERATE_TOKEN_ID_ERROR = "Exception in generateId() - DBStore";
    public static GET_TOKEN_FILE_ERROR1 = "Exception in FileStore : Given user authentication details not found.";
    public static ACCESS_TOKEN_USING_REFRESH_TOKEN_MESSAGE = "Access token can be generated by refresh token";
    public static ACCESS_TOKEN_USING_GRANT_TOKEN_MESSAGE = "Access token can be generated by grant token.";
    public static GET_TOKEN_BY_USER_NAME_ERROR = "Exception in getToken() - OAuthToken : Given user_name token details not found, Please give required item";
    public static PRIMITIVE_TYPES = [ 'string', 'number', 'boolean', 'bigint'];
    ...
    public static SDK_VERSION = "4.0.0";
    ...
    public static GIVEN_VALUE = "given-value";
    ...
    public static TIMEZONE_NAMESPACE = 'TimeZone';
    ...
    public static ENVIRONMENT1 = "_environment";
    ...
    public static PRICING_DETAILS = 'core/com/zoho/crm/api/record/pricing_details';
    ...
    public static USER_NAMESPACE = 'core/com/zoho/crm/api/users/minified_user';
    public static MODULE_NAMESPACE = 'core/com/zoho/crm/api/modules/modules';
    public static LAYOUT_NAMESPACE = 'core/com/zoho/crm/api/layouts/layouts';
    public static LINETAX = "core/com/zoho/crm/api/record/line_tax";
    ...
    public static PRICING_DETAILS_API_NAME = "Pricing_Details";
    ...
    public static SET_TO_CONTENT_TYPE = ["/crm/bulk/v6/read", "/crm/bulk/v6/write"];
    ...
    public static SDK_NAME = "typescript-6.0";
    ...
    public static OAUTH_MANDATORY_KEYS1 = [Constants.CLIENT_ID, Constants.CLIENT_SECRET];
    ...
    public static NUMBER_TYPE = "[object Number]";
    public static PRODUCT_NAME = "Product_Name";
    public static TERRITORIES = "territories";
    public static TERRITORY_NAMESPACE = "core/com/zoho/crm/api/record/territory";
    public static LINEITEM_PRODUCT = "core/com/zoho/crm/api/record/line_item_product";
    public static DISCOUNT = "Discount";
    public static TAX = "TAX";
    public static TAX_NAMESPACE = "core/com/zoho/crm/api/record/tax";
    public static MULTI_SELECT_LOOKUP = "multiselectlookup";
    public static MULTI_USER_LOOKUP = "multiuserlookup";
    public static TERRITORY = "Territory";
    public static INVENTORY_MODULES_ITEMS = ["invoiced_items", "quoted_items", "purchase_items", "ordered_items"];
    public static PRODUCTS = "Products";
    public static OAUTH_MANDATORY_KEYS2 = [Constants.GRANT_TOKEN, Constants.REFRESH_TOKEN];
    public static IMAGEUPLOAD_NAMESPACE = "core/com/zoho/crm/api/record/image_upload";
    public static MULTI_MODULE_LOOKUP = "multi_module_lookup";
    public static IMAGE_UPLOAD_NAMESPACE = "core/com/zoho/crm/api/record/image_upload";
    public static AU_DATACENTER = ["https://www.zohoapis.com.au", "https://sandbox.zohoapis.com.au", "https://developer.zohoapis.com.au", "https://accounts.zoho.com.au/oauth/v2/token","au"];
    public static CN_DATACENTER = ["https://www.zohoapis.com.cn", "https://sandbox.zohoapis.com.cn", "https://developer.zohoapis.com.cn", "https://accounts.zoho.com.cn/oauth/v2/token","cn"];
    public static EU_DATACENTER = ["https://www.zohoapis.eu", "https://sandbox.zohoapis.eu", "https://developer.zohoapis.eu", "https://accounts.zoho.eu/oauth/v2/token","eu"];
    ...
    public static API_DOMAIN = "api_domain";
    public static ENVIRONMENT_ERROR_RESPONSE = "Exception in set the api environment.";
    public static PARAM_EXCEPTION = "Exception in forming request Parameter : ";
	public static HEADER_EXCEPTION = "Exception in forming request Header : ";
    ...
    public static ROLLUP_SUMMARY = "rollup_summary"
}