...
class ActionWrapper implements Model{
	 ...
	 * @param hipaaCompliance An instance of ActionResponse
	 */
	public setHipaaCompliance(hipaaCompliance: ActionResponse): void	{
