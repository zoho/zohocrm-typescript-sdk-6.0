...
class Field<T>{
	...
	public static Appointments__s = class {
		...
		public static APPOINTMENT_FOR: Field<Array<Record>> = new Field<Array<Record>>("Appointment_For");
		...
		public static RESCHEDULED_BY: Field<Users> = new Field<Users>("Rescheduled_By");
		...
		public static CANCELLED_BY: Field<Users> = new Field<Users>("Cancelled_By");
