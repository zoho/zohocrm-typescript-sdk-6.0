...
import {InventoryTemplates} from "./inventory_templates";
import {ResponseHandler} from "./response_handler";
import {Model} from "../../../../../../utils/util/model";

class ResponseWrapper implements Model, ResponseHandler{

	private inventoryTemplates: Array<InventoryTemplates>;
	private info: Info;
	 ...
	 */
	public getInventoryTemplates(): Array<InventoryTemplates>	{
	 ...
	 */
	public setInventoryTemplates(inventoryTemplates: Array<InventoryTemplates>): void	{
