...
class RolesOperations{
	 ...
	 * @throws SDKException
	 */
	public async createRoles(request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/settings/roles");
		handlerInstance.setAPIPath(apiPath);
	 ...
	 * @throws SDKException
	 */
	public async updateRoles(request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/settings/roles");
		handlerInstance.setAPIPath(apiPath);
	 ...
	 * @throws SDKException
	 */
	public async updateRole(roleId: bigint, request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/settings/roles/");
		apiPath = apiPath.concat(roleId.toString());
	 ...
	 * @throws SDKException
	 */
	public async deleteRole(roleId: bigint, paramInstance?: ParameterMap): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v6/settings/roles/");
		apiPath = apiPath.concat(roleId.toString());
...
class DeleteRoleParam{
	...
	public static TRANSFER_TO_ID: Param<bigint> = new Param<bigint>("transfer_to_id", "com.zoho.crm.api.Roles.DeleteRoleParam");
}
