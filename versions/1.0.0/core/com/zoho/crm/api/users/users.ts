...
class Users extends Record implements Model{
	 ...
	 * @returns A BigInt representing the phone
	 */
	public getPhone(): bigint	{
	 ...
	 * @param phone A BigInt representing the phone
	 */
	public setPhone(phone: bigint): void	{
	 ...
	 * @returns A BigInt representing the mobile
	 */
	public getMobile(): bigint	{
	 ...
	 * @param mobile A BigInt representing the mobile
	 */
	public setMobile(mobile: bigint): void	{
